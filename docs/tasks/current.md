...
```text
1. 已提交并 push 到 GitHub：b3a8b7e publish two new year vision sermons。
2. 当前线上 deployment.json 仍为上一提交 51f013d，Cloudflare Pages 尚未切到包含这 2 篇文章的新提交。
3. 2 个新 URL 当前返回 200，但仍是旧首页壳，待 Cloudflare Pages 部署完成后需重新验证页面标题和正文标题。
```
